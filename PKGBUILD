...
if _is_lto_kernel && [ "$_use_lto_suffix" = "yes"  ]; then
    _pkgsuffix=okhsunrog-lto
elif ! _is_lto_kernel && [ "$_use_gcc_suffix" = "yes" ]; then
    _pkgsuffix=okhsunrog-gcc
else
    _pkgsuffix=okhsunrog
fi
...
b2sums=('6e3de2016468abfaacb4f02968118cb9e5ef4c897c9db92a72f10a5212b3080c57fcc881127dc954fa68a09442d1941f232e61ec9593924cffd39ca0be7e726d'
        ...
        '4ebfa307dcb67f5aaacafae280d062c509eae3bb7740ac927f5a416d79fbed96a4b656c7dc9580a4754beb340670b64a889a93f3e2fa7c520c93e8573f2c6568')
...
# b2sums declared near source=() at top so that conditional b2sums+=('SKIP')
# additions for optional sources are not clobbered.
